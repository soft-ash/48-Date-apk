...
import '../widgets/have_kids_options.dart';

class HaveKidsScreen extends StatelessWidget {
  const HaveKidsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    AppScreenUtil.init(context);
    final controller = Get.find<HaveKidsController>();
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: const OnboardingProgressBar(progress: 0.70),
            ),
            Expanded(
