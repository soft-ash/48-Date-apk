...
import '../widgets/did_smoke_options.dart';

class DidSmokeScreen extends StatelessWidget {
  const DidSmokeScreen({super.key});

  @override
  Widget build(BuildContext context) {
    AppScreenUtil.init(context);
    final controller = Get.find<DidSmokeController>();
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: const OnboardingProgressBar(progress: 0.55),
            ),
            Expanded(
