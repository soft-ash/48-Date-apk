...
import '../widgets/occupation_section.dart';

class BirthdayOccupationScreen extends StatelessWidget {
  const BirthdayOccupationScreen({super.key});
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: const OnboardingProgressBar(progress: 0.5),
            ),
            Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FadeInUp(
                            ...
                            child: const BirthdaySection(),
                          ),
                          SizedBox(height: 36.h),
                          FadeInUp(
                            delay: const Duration(milliseconds: 200),
                            child: const OccupationSection(),
                          ),
                          const Spacer(),
