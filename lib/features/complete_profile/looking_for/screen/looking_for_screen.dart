...
import '../widgets/looking_for_options.dart';
...
class LookingForScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Get.find<LookingForController>();
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: const OnboardingProgressBar(progress: 0.95),
            ),
            Expanded(
